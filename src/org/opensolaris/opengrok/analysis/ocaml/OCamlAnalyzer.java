...
/**
 *
 * @author Evgeny Roubinchtein
 * (copied from the Lisp analyzer made the obvious modifications)
 */
public class OCamlAnalyzer extends AbstractSourceCodeAnalyzer {
    ...
    protected JFlexTokenizer newSymbolTokenizer(Reader reader) {
        return new OCamlSymbolTokenizer(reader);
    }

    @Override
    protected JFlexXref newXref(Reader reader) {
        return new OCamlXref(reader);
    }

    static void writeXref(Reader in, Writer out, Definitions defs, Annotation annotation, Project project) throws IOException {
        OCamlXref xref = new OCamlXref(in);
